                    ...
                    <input type="text" readonly value="<?php echo $lpb->provider_name; ?>"  class="form-control" id="rekanan" name="rekanan" >                    
						...
						<label for="Nomor" class="col-sm-3 control-label">Catatan :</label>
							<div class="col-sm-8">
								...
								<textarea class="form-control" id="catatan" name="catatan">Pembayaran LPB <?php echo $lpb->lpb_code; ?></textarea>
							</div>
						</div>						
					</div>
              ...
              <tr id="tmbinput-0">
				...
				<div class="form-horizontal">
					<div class="row">
                      ...
                      <input type="hidden" id="bank_code" name="bank_code" value="11002">
									   <span class="input-group-btn">
