		...
		<div class="box-body">
                    ...
                    <input type="text" readonly value="<?php echo $lpb->provider_name; ?>"  class="form-control" id="rekanan" name="rekanan" >                    
						...
						<label for="Nomor" class="col-sm-3 control-label">Catatan :</label>
							<div class="col-sm-8">
								...
								<textarea class="form-control" id="catatan" name="catatan">Pembayaran Deposit <?php echo $lpb->provider_name; ?></textarea>
							</div>
						</div>						
					</div>
          <div class="col-sm-6" style="padding-right: 68px;">
			...
			<div class="header1">
              ...
              <tr id="tmbinput-0">
                <td><input type="text" readonly="readonly" value="13001" name="kode[]" id="kode-0" class="form-control autocomplate"></td>
                <td><input type="text" readonly="readonly" value="UANG MUKA KE SUPPLIER" name="uraian[]" id="uraian-0" class="form-control"></td>
                <td><input type="text" value="" style="text-align:right;" name="nominal[]" id="nominal-0" onblur="calculates()" onkeyup="getnumeric(this)" class="form-control" required/></td>
