	  	...
	  	<div class="box-body">
			...
			<div class="col-sm-6">
				...
				<label for="Nomor" class="col-sm-3 control-label">Tanggal :</label>
					<div class="col-sm-8">
					  <div class="input-group date" style="padding: 2px 0px 3px 2px;">
                        <input type="text" style="margin:0px;" readonly value="<?php echo date('d-m-Y') ?>" role="date" class="form-control date"  name="ajs[tgl]" >
				...
				<label for="Nomor" class="col-sm-3 control-label">Keterangan :</label>
					<div class="col-sm-8">
						<textarea class="form-control" name="ajs[keterangan]" ></textarea>						
					</div>
				</div>
				<div class="form-group">
				...
				<table id="example2" class="table table-bordered table-striped table-responsive">
		            ...
		            ?>
		            	<tr>
		            		...
		            		<td><input id="num-<?php echo $i ?>" style="width:100%; text-align:right;padding:2px;" name="nominal[]" value="<?php echo number_format($row->amount*$minus); ?>" onkeyup="getnumeric(this)"></td>
		            		<td><input name="keterangan[]" style="width:100%;padding:2px;"></td>
		            		<td id="xnum-<?php echo $i ?>" awal="<?php echo ($row->amount*$minus) ?>">0</td>
		            	</tr>
		            <?php $i++; endforeach; ?>                   
		            </tbody>
		        </table>
