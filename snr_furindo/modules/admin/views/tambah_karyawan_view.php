      ...
      <form id="formBaru" onsubmit="simpanreg(); return false;">        
        <div class="col-md-6 form-horizontal">
          <div class="row">             
            <div class="col-sm-12">    
              <div class="form-group">
                ...
                <div class="col-sm-8">
                <input type="text" name="kodeKaryawan" id="kodeKaryawan" class="form-control" required/>           
          ...
          <div class="row">             
            <div class="col-sm-12">    
              <div class="form-group">
                ...
                <div class="col-sm-8">          
                <input size="40" type="text" display="none" class="form-control" id="nama_pemilik" placeholder="Nama Lengkap Anda" name="nama" required>
                <input type="hidden" class="form-control" id="join_date" value="<?php $now = new DateTime(null, new DateTimeZone('Asia/Jakarta'));echo $now->format('Y-m-d H:i:s');?>" name="join_date">
                </div> <!-- <div class="col-sm-9">  -->
              </div> <!-- <div class="form-group"> -->
            </div>  <!-- <div class="col-sm-6"> -->
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">    
              <div class="form-group">
                ...
                <div class="col-sm-8">
                <input type="email" oninput="lookUpUsername(this.value)" class="form-control" id="email" placeholder="user@example.com" name="email" required>
          ...
          <div class="row">
            <div class="col-sm-12">    
              <div class="form-group">
                ...
                <div class="col-sm-8">
                <input type="text" onkeypress="return IsNumeric(event);" class="form-control" ondrop="return false;" onpaste="return false;" id="hp" placeholder="Nomer Telepon" name="hp">
          ...
          <div class="row">
            <div class="col-sm-12">    
              <div class="form-group">
                <label style="text-align:left" class="control-label col-sm-4" for="password">Jenis Kelamin</label>
                <div class="col-sm-4">
                <label class="radio-inline">
                  <input type="radio" name="jkl" id="jkl" value="L">L &nbsp;
                </label>
                <label class="radio-inline">
                  <input type="radio" name="jkl" id="jkl" value="P">P &nbsp;
                </label>
                </div> <!-- <div class="col-sm-9">  -->
              </div> <!-- <div class="form-group"> -->
            </div>  <!-- <div class="col-sm-6"> -->
          ...
          <div class="row">
            <div class="col-sm-12">    
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input  type="number" class="form-control" name="user_entry" value="">               
                </div> 
              </div> 
            </div>  
          </div>
          <div class="row">
            <div class="col-sm-12">    
              <div class="form-group">
                ...
                <div class="col-sm-8">          
                <textarea class="form-control" rows="3" id="alamat_pemilik" placeholder="Masukkan Alamat Anda" name="alamat"></textarea>
                </div> <!-- <div class="col-sm-9">  -->
              </div> <!-- <div class="form-group"> -->
            </div>  <!-- <div class="col-sm-6"> -->
          </div>     
          <div class="row">
            <div class="col-sm-12">    
              <div class="form-group">
                ...
                <div class="col-sm-7">          
                <button id="tbh" type="submit" class="btn btn-success" disabled><i class="fa fa-plus"></i> Tambah</button>
...
var specialKeys = new Array();
    ...
    $.post( 
        ...
        //'http://localhost/snr_new/index.php/admin/ajax_lookUpUemail',
         { email: name },
         function(response) {  
            if (response == 1) {
                //alert('username ok');
  ...
  function simpanreg()
	{
		...
		data = $("#formBaru").serialize();
		var htmlOut = ajaxFillGridJSON('admin/insert_karyawan', data);
