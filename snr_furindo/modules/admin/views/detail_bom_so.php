...
<div class="content">        
	<div class="box box-primary">
		<div class="box-body">
			<form id="addkso" onsubmit="simpanreg(<?php echo $idso; ?>); return false;">
							...
							<div class="col-sm-8">								
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
						       			<button type="button" id="btnCariProduct" class="btn btn-success"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>&nbsp;Cari</button>
						       		</span>
						       	</div>
							</div>							
						</div>
					...
					<table id="tables"  width="100%" cellspacing="0" aria-describedby="tabel transaksi" role="grid" class="table table-striped table-bordered">
						...
						<tbody name="tabelContent" id="tabelContent">
							...
							<tr>
								...
								<td><input name="qty[]" type="number" step="0.01" min="1" class="form-control" value="<?php echo $value->qty ?>" required/></td>
					...
					<table id="tables"  width="100%" cellspacing="0" aria-describedby="tabel transaksi" role="grid" class="table table-striped table-bordered">
						...
						<tbody name="tabelContent" id="tabelContent">
							...
							<tr>
								...
								<td><input name="qty_ld[]" type="number" step="0.01" class="form-control" value="<?php echo $values->qty ?>" required/></td>
		...
		<div class="form-horizontal footer">
				<div class="row" id="addcol">
					<div class="col-sm-6">
						...
						<button type="button" onclick="back(<?php echo $product->product_id; ?>, <?php echo $idso; ?>)" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-minus-sign"></span> Batal</button>
...
function simpanreg(ids)
	{
		...
		$.post(target, data, function(e){
			...
			if(e==1){
				...
				var htmlOut = ajaxFillGridJSON('admin/DetailSO', {IDBidang : ids}); 
	...
	function back(idx, so)

	  {     
	    var htmlOut = ajaxFillGridJSON('admin/DetailSO', {idx : idx, IDBidang : so}); 
