				...
				<div class="row">
					<div class="col-sm-7">
						<div class="form-group">
							...
							<div class="col-sm-8">								
								...
								<div class="input-group">
                                    <input readonly type="text" id="product_code" value="" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input readonly type="text" id="product_name"  value="" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input readonly type="text" id="product_price"  value="" class="form-control">
			...
			<div class="header1">
				...
				<div class="table-responsive" style="width:90%; margin:0px auto;">     
					<table id="tables"  width="100%" cellspacing="0" aria-describedby="tabel transaksi" role="grid" class="table table-striped table-bordered">
						...
						<tfoot>
							<button type="button" onclick="deletedata3()" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span> Hapus semua</button>
						</tfoot>
					</table>					
			   </div>					
		</div>
