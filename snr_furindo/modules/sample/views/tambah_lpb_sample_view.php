				...
				<div class="row">
					<div class="col-sm-6">
						...
						<label for="kegiatan" class="col-sm-3 control-label">Vendor :</label>
							<div class="col-sm-8" id="col-kontak">
								<div class="input-group">
                                    ...
                                    <input type="hidden" id="sample" value="" name="sample" >
									<span class="input-group-btn">
						...
						<label for="Nomor" class="col-sm-3 control-label">Kategories :</label>
							<div class="col-sm-8">								
                                <input type="text" readonly value="Sample" class="form-control" id="kategories" name="kategories" >
							</div>
						</div>
					...
					<div class="col-sm-6">
						...
						<label for="Nomor" class="col-sm-3 control-label">Biaya Kirim :</label>
							<div class="col-sm-8">
								<div class="input-group">
                                    <input onkeyup='getnumericid(this)' onblur='calculates()' type="text" value="0" name="biaya" class="form-control" id="biaya" >
...
function loadGridDataSO(){ 
        ...
        ajaxDataGrid('<?php echo base_url()?>sample/addTablePOSample', {idx : produk_id}, 'tableGridDataSales');       
    }	

function loadGridDataRekanan(){ 
		var produk_id = $('#caridatarekanan').val();

        ajaxDataGrid('<?php echo base_url()?>sample/addTableRekanan', {idx : produk_id}, 'tableGridDataRekanan'); 
        $('#example4').dataTable({
          "bPaginate": true,
          "bLengthChange": true,
          "bFilter": true,
	...
	{ 
		...
		var idbutton = "delete-button-"+$("#tabelContent tr").length;
			...
			var row  = "<input type='hidden' value='0' name='iddetail[]'/>";
				...
				row += "<td><input type='text'  value='"+harga+"' name='nominal[]' id='nominal-"+lengths+"' atm='nominal-"+lengths+"' onblur='calculates()' onkeyup='getnumeric(this)' class='form-control'/></td>";
				...
				row += "<td><input type='number' min='0' max='"+qty+"' value='"+qty+"' name='qty[]' id='qty-"+lengths+"' onkeyup='getnumeric(this)' atm='nominal-"+lengths+"' class='form-control autocomplate'/></td>";
...
function simpanreg()
	{
		...
		var htmlOut = ajaxFillGridJSON('sample/saveLPBSample', data);	    		
	   	//$('.content-wrapper').html(htmlOut);
	   	//return false;
