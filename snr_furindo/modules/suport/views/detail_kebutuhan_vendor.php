	...
	function loadGridData(){
         ...
         {		
             ...
             dataFields: [
                  ...
                  { name: "mat_code",	type: "string" },
                  { name: "mat_name",	type: "string" },
                  { name: "date", type: "date" },
            ...
            url : "suport/GetDaftarKebutuhanVendor",
        ...
        $("#ajaxTreeGrid").jqxGrid(
        {
            ...
            columns: [
              ...
              { text: 'SO Ref', cellsAlign: 'center', align: 'center', dataField: 'so', width : '8%'},
              { text: 'Kode', cellsAlign: 'center', filtertype: 'checkedlist', align: 'center', dataField: 'kode', width : '10%'},
              { text: 'Nama', cellsAlign: 'left', filtertype: 'checkedlist', align: 'center', dataField: 'nama', width : '18%'},
              { text: 'Mat Kode', cellsAlign: 'left', filtertype: 'checkedlist', align: 'center', dataField: 'mat_code', width : '10%'},
              { text: 'Mat Name', cellsAlign: 'left', align: 'center', dataField: 'mat_name', width : '20%'},
              ...
              { text: 'Harga', cellsAlign: 'right', align: 'center', dataField: 'price', cellsformat: 'f', aggregates: ['sum'], width : '11%'},
              //{ text: 'Order', cellsAlign: 'center', align: 'center', dataField: 'datang', width : '10%'},
              { text: 'Qty', cellsAlign: 'center', align: 'center', dataField: 'action', cellsformat: 'f', aggregates: ['sum'], width: '8%' }
            ]
