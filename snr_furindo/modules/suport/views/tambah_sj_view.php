...
<div class="content">        
	<div class="box box-primary">
		<div class="box-body">
			...
			<input type="hidden" id="sjid" name="sj_id" value="" required/>
				...
				<div class="row">
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-8" id="col-kontak">
							<div class="input-group">
                                <input type="text" readonly  value="" class="form-control" id="vendor" >
                                <input type="hidden" id="id_rekanan" value="" name="id_rekanan" >
					...
					<div class="col-sm-6">
						...
						<label for="Nomor" class="col-sm-3 control-label">Diangkut melalui :</label>
							<div class="col-sm-8">
								<input class="form-control" id="" name="kendaraan" value="" required/>
							</div>
						</div>
						...
						<label for="Nomor" class="col-sm-3 control-label">Nomor Kendaraan :</label>
							<div class="col-sm-8">
								<input class="form-control" id="" name="napol" value="" required/>
							</div>
						</div>
...
function addRekanan(idx, nama, code, ids)
	{ 
...
function addProduct(objReference)
	{ 
		...
		var idbutton = "delete-button-"+$("#tabelContent tr").length;
			...
			var row  = "<tr id='tmbinput-"+lengths+"'><input type='hidden' value='"+po+"' name='purchase[]''/>";
