  ...
  function printShow(idx)
  {
	...
	function loadGridData(){
         ...
         {		
            ...
            url : "suport/GetDaftarDetailKebutuhan",
        ...
        $("#ajaxTreeGrid").jqxGrid(
        {
            ...
            columns: [
              ...
              { text: 'Nama', cellsAlign: 'left', align: 'center', dataField: 'nama', width : '18%'},
              { text: 'Mat Kode', cellsAlign: 'left', align: 'center', dataField: 'mat_code', width : '10%'},
