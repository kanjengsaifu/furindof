...
function loadGridData(){ 
		...
		var idso = $('#id_sales').val();		 
        ajaxDataGrid('<?php echo base_url()?>suport/addTableSo_lc', {idx : produk_id, ids : idso}, 'tableGridData');
        $('#example3').dataTable({
          "bPaginate": true,
          "bLengthChange": true,
          "bFilter": true,
	...
	{ 
		...
		var idbutton = "delete-button-"+$("#tabelContent tr").length;
			...
			var row  = "<tr id='tmbinput-"+lengths+"'>";
				...
				row += "<td><input type='number' min='1' step='0.01' value='' name='qty[]' id='qty-"+lengths+"' class='form-control autocomplate' required/></td>";
