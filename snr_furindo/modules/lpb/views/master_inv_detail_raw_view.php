<div class="content-header">   
	<h1>Daftar History Inventory Raw Material</h1>
</div>
	...
	function loadGridData(){
        ...
        $("#ajaxTreeGrid").jqxDataTable(
        {
            ...
            columns: [
              ...
              { text: 'Stock Awal', cellsAlign: 'center', align: 'center', dataField: 'awal', width : '10%'},
              { text: 'Qty', cellsAlign: 'center', align: 'center', dataField: 'qty', width : '8%'},
              { text: 'Total Stock', cellsAlign: 'center', align: 'center', dataField: 'ttl_qty', width : '10%'},
