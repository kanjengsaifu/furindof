...
<div class="content-header">        
	<h1>Tambah LPB Suport Material</h1>
</section>
<div class="content">        
	...
	{ 
		...
		var idbutton = "delete-button-"+$("#tabelContent tr").length;
			...
			var row  = "<input type='hidden' value='0' name='iddetail[]'/>";
				...
				row += "<td><input type='number' readonly value='"+beli+"' class='form-control autocomplate'/><input type='hidden' value='"+kbt+"' id='ttl-"+lengths+"' name='ttl_harga[]'/></td>";
				row += "<td><input type='number' min='1' step='0.01' max='"+qty+"' value='"+qty+"' name='qty[]' id='qty-"+lengths+"' onclick='getnumeric(this)' atm='nominal-"+lengths+"' class='form-control autocomplate'/></td>";
...
function simpanreg()
	{
		...
		var htmlOut = ajaxFillGridJSON('lpb/saveLPBSM', data);	    		
	   	//$('.content-wrapper').html(htmlOut);
	   	//return false;
