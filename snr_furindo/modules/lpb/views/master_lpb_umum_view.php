...
<script>
  ...
  function deleteConfirmShow(ids)
    { 
      ...
      var nama = dataKaryawan.kode;
        ...
        if (isDelete) sendRequestForm('lpb/HapusLpbUmum', {ID : idx}, 'box-body');
        kodeTipeKaryawan = ajaxFillGridJSON('lpb/lpb_umum'); 
  ...
  function Add_raw()
    ...
    {     
      ...
      var loadhtml = "<?php echo site_url("lpb/tambah_lpb_umum")?>"; 
  ...
  function dialogFormEditShow(idx)
    {
      kodeTipeKaryawan = ajaxFillGridJSON('lpb/edit_lpb_umum', {IDBidang : idx}); 
      $('.content-wrapper').html(kodeTipeKaryawan);
