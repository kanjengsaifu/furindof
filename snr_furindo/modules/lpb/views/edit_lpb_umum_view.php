						...
						<label for="Nomor" class="col-sm-3 control-label">Biaya Kirim :</label>
							<div class="col-sm-8">
								<div class="input-group">
                                    <input oninput='getnumericid(this)' onblur='calculates()' type="text" value="<?php echo $LPB->lpb_biaya; ?>" name="biaya" class="form-control" id="biaya" >
...
function simpanreg()
	{
		...
		var htmlOut = ajaxFillGridJSON('lpb/updateLPBUmum', data);	    		
	   	//$('.content-wrapper').html(htmlOut);
	   	//return false;
