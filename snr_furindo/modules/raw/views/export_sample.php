<?php
	...
	$code_po = $list_history->row()->purchase_order_sample_code;
...
<table id="item-list" width="100%" border="0 #012473  !important;" style="color:#012473; border-color:#012473;">
	...
	<tr height="150px" style="color:#012473; border-color:#012473; vertical-align:middle;">
		<td style="color:#012473; border-color:#012473; vertical-align:middle;">SAMPLE <?php echo substr ($row->material_code,0,9);  ?> </td>
		...
		<td style="text-align: right, vertical-align:middle; vertical-align:middle;"><?php echo $d_qty = $row->qty;?></td>
		<!-- <td style="text-align: right, vertical-align:middle;"><?php //echo $d_qty = $row->total_qty;?></td>	 -->
		<td style="color:#012473; border-color:#012473; vertical-align:middle;">PCS</td>
		<td style="text-align: right; border-color:#012473; vertical-align:middle;" ><?php $price = $row->price; echo 'Rp '.number_format($price); ?></td>
