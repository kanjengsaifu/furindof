...
<script>
	...
	{ 
	  	...
	  	if (isDelete) sendRequestForm('raw/HapusSample', {ID : ids}, 'box-body');
	  	kodeTipeKaryawan = ajaxFillGridJSON('raw/po_sample'); 
    ...
    function Add_raw()
	  ...
	  {     
	    ...
	    var loadhtml = "<?php echo site_url("raw/tambah_po_sample")?>"; 
    ...
    //var IDBidang = $(objSource).val();
		...
		kodeTipeKaryawan = ajaxFillGridJSON('raw/edit_po_sample', {IDBidang : idx}); 
		$('.content-wrapper').html(kodeTipeKaryawan);
  ...
  function printShow(idx)
  {
    ...
    var htmlOut = "<?php echo site_url("raw/printposample")?>/"+idx;
	...
	function loadGridData(){
        ...
        $("#ajaxTreeGrid").jqxGrid(
        {
            ...
            columns: [
              ...
              //{ text: 'SO Ref', cellsAlign: 'center', filtertype: 'checkedlist', align: 'center', dataField: 'ref', width : '8%'},
              { text: 'Kode', cellsAlign: 'center', filtertype: 'checkedlist', align: 'center', dataField: 'kode', width : '12%'},              
              // { text: 'Foto', cellsAlign: 'left', align: 'center', dataField: 'foto', width : '12%'},
              { text: 'Nama', cellsAlign: 'left', filtertype: 'checkedlist', align: 'center', dataField: 'nama', width : '16%'},
