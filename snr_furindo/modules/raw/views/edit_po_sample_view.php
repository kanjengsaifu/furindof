				...
				<div class="row">
					<div class="col-sm-6">
						...
						<label for="Nomor" class="col-sm-3 control-label">NO PO :</label>
							<div class="col-sm-8">
								<input class="form-control" id="nomor" name="nomor" value="<?php echo $PO->row()->purchase_order_sample_code ?>" required/>
							</div>
						</div>
						<!-- <div class="form-group">
						...
						<label for="kegiatan" class="col-sm-3 control-label">Vendor :</label>
							<div class="col-sm-8" id="col-kontak">
								<div class="input-group">
                                    <input type="text" readonly  value="<?php echo $PO->row()->provider_name ?>" class="form-control" id="vendor" name="vendor" >
                                    <input type="hidden" id="id_rekanan" value="<?php echo $PO->row()->provider_id ?>" name="id_customer" >
									<span class="input-group-btn">
						...
						<label for="Nomor" class="col-sm-3 control-label">PO Date :</label>
							<div class="col-sm-8">
								<div class="input-group date1">
                                    <input type="text" readonly value="<?php echo  date('d-m-Y', strtotime($PO->row()->delivery_date)) ?>" onchange="dateupdate()" role="date" class="form-control date1" id="tglreg" name="tglreg" >
						...
						<label for="Nomor" class="col-sm-3 control-label">Delivery Date :</label>
							<div class="col-sm-8">
								<div class="input-group date">
                                    <input type="text" readonly role="date" value="<?php echo  date('d-m-Y', strtotime($PO->row()->date)) ?>" class="form-control date" id="tglship" name="tgldel" >
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span> 
                                  </div>
							</div>
						</div>
					...
					<div class="col-sm-6">
						...
						<label for="Nomor" class="col-sm-3 control-label">Phone :</label>
							<div class="col-sm-8">
								<div class="input-group">
                                    <input type="text" readonly value="<?php echo $PO->row()->provider_phone ?>" role="date" class="form-control" id="phone" >
						...
						<label for="Nomor" class="col-sm-3 control-label">Address :</label>
							<div class="col-sm-8">
								<div class="input-group">
                                    <input type="text" readonly value="<?php echo $PO->row()->provider_address ?>" role="date" class="form-control" id="address" >
						...
						<label for="Nomor" class="col-sm-3 control-label">Note :</label>
							<div class="col-sm-8">
								<textarea class="form-control" name="note"><?php echo $PO->row()->desc ?></textarea>
							</div>
						</div>
					</div>
				...
				<div class="table-responsive" style="width:99%; margin:0px auto;">     
					<table id="tables"  width="100%" cellspacing="0" aria-describedby="tabel transaksi" role="grid" class="table table-striped table-bordered">
						...
						<?php 
			            	...
			            	$num = $no+1;	
			            ?> 
			            	<input type='hidden' value='<?php echo $row->purchase_order_sample_id ?>' name='iddetail[]'/>
			            	<tr id='tmbinput-<?php echo $no; ?>'>
								<td><?php echo $num; ?><input type='hidden' value='<?php echo $row->material_id; ?>' name='id_material[]'/><input type='hidden' value='<?php echo $row->product_id; ?>' name='id_product[]'/></td>
								<td><input type='text' readonly='readonly' value='<?php echo $row->material_code; ?>' id='uraian-<?php echo $no; ?>' class='form-control'/></td>
								<td><input type='text' value='<?php echo $row->material_name; ?>' style='text-align:left;' id='nmproduct-<?php echo $no; ?>'class='form-control'/></td>
								<td><input type='text' value='<?php echo $row->price; ?>' name='nominal[]' id='nominal-<?php echo $no; ?>' onkeyup='getnumeric(this)' class='form-control'/></td>
								<td><input type='number' min='1' max='' value='<?php echo $row->qty; ?>' name='qty[]' id='qty-<?php echo $no; ?>' class='form-control autocomplate'/></td>
								<td><input type='text' name='desc[]' value='<?php echo $row->remax; ?>' id='desc-<?php echo $no; ?>' class='form-control autocomplate'/></td>
								<td colspan='2' style='text-align:center;'><button type='button' onclick='deleterow(<?php echo $no; ?>)' id='"+idbutton+"' title='hapus data' class='btn btn-xs btn-danger'><span class='glyphicon glyphicon-minus-sign'></span></button></td>
							</tr>   
						<?php $no++; } ?>  
...
function simpanreg()
	{
		...
		var htmlOut = ajaxFillGridJSON('raw/updateProductSample', data);	    		
	   	//$('.content-wrapper').html(htmlOut);
	   	//return false;
