				...
				<table id="example2" class="table table-bordered table-striped table-responsive">
		            <thead style="">
		                <tr>            
		                    ...
		                    <th style="text-align:center; width:40%"> Nama Produk </th>
...
<script>
    ...
    function loadGridData(lmt){ 
        ...
        ajaxDataGrid('<?php echo base_url()?>raw/GetDetailRawBody', {idx : lmt}, 'ajaxTreeGrid');       
    }   
