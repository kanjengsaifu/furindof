	...
	function loadGridData(){
        ...
        $("#ajaxTreeGrid").jqxGrid(
        {
            ...
            columns: [
              ...
              { text: 'Qty', cellsAlign: 'center', align: 'center', dataField: 'qty', cellsformat: 'f', aggregates: ['sum'], width : '10%'},
              { text: 'Sisa', cellsAlign: 'center', align: 'center', dataField: 'sisa', cellsformat: 'f', aggregates: ['sum'], width : '10%'},
              { text: 'Order', cellsAlign: 'center', align: 'center', dataField: 'datang', cellsformat: 'f', aggregates: ['sum'], width : '10%'},
