<?php $tgl = date("d-m-Y", strtotime($PO->purchase_order_date)); ?>
<style>
	.seperator{
				...
				<div class="table-responsive" style="width:90%; margin:0px auto;">     
					<table id="tables"  width="100%" cellspacing="0" aria-describedby="tabel transaksi" role="grid" class="table table-striped table-bordered">
						...
						?>
							...
							<td><input type='number' min='1' max='<?php echo $row->purchase_order_detail_qty ?>' value='<?php echo $row->purchase_order_detail_qty ?>' name='qty[]' id='qty-<?php echo $num ?>' class='form-control autocomplate'/></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<input type="text" id="caridata" oninput="loadGridData1()" placeholder="Cari data product" value="" class="form-control" autofocus>        
