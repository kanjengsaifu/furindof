...
<?php 
  $kas_data = $this->db->query("SELECT * from trx_jurnal left join mst_provider on mst_provider.provider_id = trx_jurnal.provider_id where id_kategori = 1 AND nobukti like '%BKK%' AND id_jurnal = '".$kas."'")->row();
?>
...
<table class="tg" width="100%">
   ...
   <th style="border-style:none; font-size:11px; height:-10px;">
    ...
    <th colspan="1" style="border-style:none; font-size:11px;">
      ...
      <label style="font-family:courier; font-size:11px; ">Kas / Bank : Kas di Tangan IDR</label>
    </th>
  </tr>   
  <tr>
  ...
  <tr>
      <td colspan="4" style="border-style:none;border-bottom:1px solid black; font-size:11px;">
        <label style="font-family:courier; font-size:11px; ">Pembayaran : <?php echo $kas_data->memo; ?> </label><br>
  ...
  <tr>
    ...
    <td style="text-align:right;"><?php echo 'Rp '.number_format($ttl).'.00';  ?></td>
  </tr>
  <tr>      
