...
<script>
	...
	$(document).ready(function () {
...

        {
			...
			var html = "<?php echo site_url("transaksi/tambahpinjaman")?>";
	...
	function loadGridData(){
         ...
         {		
            ...
            url : "transaksi/GetDaftarPinjaman",
...

        {
            ...
            columns: [
              ...
              { text: 'Nama', cellsAlign: 'left', align: 'center', dataField: 'nama', width : '45%'},
	...
	function dialogFormDetailShow(idx)

	{
		var htmlOut = ajaxFillGridJSON('transaksi/detailpinjaman', {idx : idx}); 
