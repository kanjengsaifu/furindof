...
<script>
	...
	$(document).ready(function () {
...

        {
			...
			var html = "<?php echo site_url("transaksi/tambahsimpanan")?>";
	...
	function loadGridData(){
         ...
         {		
            ...
            url : "transaksi/GetDaftarSimpanan",
...

        {
            ...
            columns: [
              ...
              { text: 'Nominal', cellsAlign: 'right', align: 'center', dataField: 'nominal', width : '25%'},
