			...
			<div class="form-horizontal footer">
				<div class="row" id="addcol">
					<div class="col-sm-6" style="padding-left: 30px;">
						...
						<!-- <button onclick="setTimeout(dialogFormPrint(<?php echo $bkk->id_jurnal; ?>),3000)" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-print"></span> Simpan Data dan Cetak</button>
...
function loadGridData(tipe){
	...
	function simpanreg()
	{
		var target = "<?php echo site_url("transaksi/updatebkk")?>";
