<div class="main-footer footerfixed">
    <div class="pull-right hidden-xs">
        <b>Version</b> Beta 1.0
    </div>
    <strong>Copyright &copy; 2015 <a href="http://www.binasejahtera.or.id">SNR Furindo</a>.</strong> All rights reserved.
</div>
</div>
<!-- ./wrapper -->
<!-- jQuery UI 1.11.2 -->
<script src="assets/plugins/jquery-ui-1.11.2/jquery-ui.min.js" type="text/javascript"></script>
...
<!-- treeGrid Bootstrap -->
<script src="assets/plugins/treegrid/js/jquery.treegrid.js" type="text/javascript"> </script>
<script src="assets/plugins/treegrid/js/jquery.treegrid.bootstrap3.js" type="text/javascript"> </script>
<!--jqWidget -->
...
<script type="text/javascript" src="assets/plugins/jqwidgets/jqxdropdownbutton.js"></script>
<script type="text/javascript" src="assets/plugins/jqwidgets/jqxlistbox.js"></script>
<script type="text/javascript" src="assets/plugins/jqwidgets/jqxnumberinput.js"></script>
...
<!--tinysort-->
<script src="assets/plugins/tinysort/tinysort.min.js" type="text/javascript"></script>
<script src="assets/plugins/tinysort/tinysort.min.js" type="text/javascript"></script>
<script src="assets/plugins/tinysort/tinysort.charorder.min.js" type="text/javascript"></script>
<!-- modernizr -->
