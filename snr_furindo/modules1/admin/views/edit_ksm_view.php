<?php //echo "<pre>";print_r($_SESSION);"</pre>";exit(); ?>
...
<div class="content-header" id="mainMenu">   
	<h1>Edit Kelompok Swadaya Masyarakat</h1>
</div>
<div class="content">
	<div style="background:#ECF0F5;" class="box box-warning">
		...
		<form id="form-regksm" onsubmit="simpanreg(); return false;">			
			<div class="content" style="min-height:350px;">
				<div class="col-md-6">
					<div class="form-horizontal">
						<input type="hidden" value="<?php echo $dataksm->id_ksm ?>" name="idksm"/>
						<div class="row">
							<div class="col-sm-12">    
								  <div class="form-group">
									  <label for="kasbank" class="control-label col-sm-3">Kode KSM :</label>
									  <div class="col-sm-8">          
										<input type="text" readonly="true" value="<?php echo $dataksm->kode_ksm ?>" class="form-control" name="noreg"/>
									  </div>
								  </div>
							  </div>
						</div>
						<div class="row">
							<div class="col-sm-12">    
								  <div class="form-group">
									  ...
									  <div class="col-sm-8">
										<input type="text" value="<?php echo $dataksm->nama_ksm ?>"  id="namaksm" class="form-control pull-right" name="namaksm" required/>
									  </div>								  
								  </div>
							  </div>
						</div>
								  ...
								  <div class="form-group">
									  ...
									  <div class="col-sm-8">          
										<div class="input-group">
										  <input type="text" name="tglreg" value="<?php echo date('d-m-Y', strtotime($dataksm->tgl_daftar)) ?>"  readonly="readonyl" class="form-control pull-right date">
						...
						<div class="row">
							<div class="col-sm-12">    
								  <div class="form-group">
									  ...
									  <div class="col-sm-8">
										<input type="text" value="<?php echo $dataksm->Jenis_usaha ?>"  id="bidangusaha" class="form-control pull-right" name="bidangusaha" required/>
									  </div>								  
								  </div>
							  </div>
						</div>
						<div  class="row">
								<div class="col-sm-12">    
									  <div class="form-group">
										  ...
										  <div class="col-sm-8">          
											<textarea type="text"  id="diskripsi" class="form-control" name="diskripsi_ksm"><?php echo $dataksm->deskripsi; ?></textarea>
										  </div>
									  </div>				
									  ...
									  <div class="col-sm-12 ">          
										<table border="0" class="table table-bordered">
											...
											<tr>
												<td>1</td>
												<td>Proposal</td>
												<td><input type="radio" <?php if($dataksm->proposal == 1){ echo "checked=checked"; }?> value="1" name="proposal2" />Sesuai <input type="radio" <?php if($dataksm->proposal == 0){ echo "checked=checked"; }?> value="0" name="proposal2" />Tidak Sesuai</td>
											</tr>
											<tr>
												<td>2</td>
												<td>Susunan Pengurus</td>
												<td><input type="radio" <?php if($dataksm->susunan_pengurus == 1){ echo "checked=checked"; }?>  value="1" name="pengurus" />Sesuai <input type="radio" <?php if($dataksm->susunan_pengurus == 0){ echo "checked=checked"; }?> value="0" name="pengurus" />Tidak Sesuai</td>
											</tr>
											<tr>
												<td>3</td>
												<td>KTP Anggota</td>
												<td><input type="radio" <?php if($dataksm->ktp == 1){ echo "checked=checked"; }?> value="1" name="keanggotaan" />Sesuai <input type="radio" <?php if($dataksm->ktp == 0){ echo "checked=checked"; }?> value="0" name="keanggotaan" />Tidak Sesuai</td>
											</tr>
											<tr>
												<td>4</td>
												<td>Modal Usaha</td>
												<td><input type="radio" <?php if($dataksm->modal_usaha == 1){ echo "checked=checked"; }?> value="1" name="modalusaha" />Sesuai <input type="radio" <?php if($dataksm->modal_usaha == 0){ echo "checked=checked"; }?> value="0" name="modalusaha" />Tidak Sesuai</td>
											</tr>
											<tr>
												<td>5</td>
												<td>Rencana Anggaran</td>
												<td><input type="radio" <?php if($dataksm->rab == 1){ echo "checked=checked"; }?> value="1" name="rab" />Sesuai <input type="radio" <?php if($dataksm->rab == 0){ echo "checked=checked"; }?> value="0" name="rab" />Tidak Sesuai</td>
											</tr>
											<tr>
												<td>6</td>
												<td>Tujuan Penggunaan Dana</td>
												<td><input type="radio" <?php if($dataksm->penggunaan_dana == 1){ echo "checked=checked"; }?> value="1" name="tujuan"/>Sesuai <input type="radio" <?php if($dataksm->penggunaan_dana == 0){ echo "checked=checked"; }?> value="0" name="tujuan"/>Tidak Sesuai</td>
											</tr>
											<tr>
												<td>7</td>
												<td>Pengesahan</td>
												<td><input value="1" <?php if($dataksm->pengesahan == 1){ echo "checked=checked"; }?> type="radio" name="pengesahan" />Sesuai <input <?php if($dataksm->pengesahan == 0){ echo "checked=checked"; }?> value="0" type="radio" name="pengesahan" />Tidak Sesuai</td>
											</tr>
										</table>
									  </div> 
								  </div> 
			...
			<?php $i=0; foreach($datanasabah->result() as $nasabah) {  ?>
			<div class="content" id="tmbinput-<?php echo $i ?>"  style="margin-top:-60px; border-top:0px solid #3C8DBC; cursor:pointer;">
				<div  type="button" onclick="ujiback(<?php echo $i+1; ?>)" style="background-color: #605ca8; color: white; margin: 60px -5px 10px -5px; padding: 10px; text-align: center; font-size: 24px;">
					Form Anggota <?php echo $i+1; ?>
				</div>
				<input type="hidden" value="<?php echo $nasabah->id_nasabah ?>" name="idnasabah[]"/>
				<?php if ($i==0) { ?>
				<div class="row" style="margin-bottom:10px;">
					<div class="col-md-12">
					<input type="hidden" id="seqcode" />
						<button style="margin:1px;" type="button" onclick="ujinext(<?php echo $i; ?>)" class="btn btn-primary btn-sm pull-right">						
							Next
							<span class="glyphicon glyphicon-forward" aria-hidden="true"></span>
						</button>
						</button>
						<button style="margin:1px;" type="button" onclick="hapusanggota(<?php echo $i ?>,<?php echo $nasabah->id_nasabah ?>)" id="hapushtml-'+obj+'" class="btn btn-danger btn-sm pull-right">
						...
						<!-- <button style="margin:1px;" type="button" onclick="ujiback(<?php echo $i; ?>)" class="btn btn-primary btn-sm pull-right">
							...
							<div style="margin-bottom:5px;" class="row">
								<div class="col-sm-12">    
									  <div class="form-group">
										  ...
										  <div class="col-sm-8">          
											<input type="text" value="<?php echo $nasabah->kode_nasabah?>" readonly id="noanggota-<?php echo $i?>" class="form-control" name="noanggota[]"/>
										  </div> 
									  </div> 
								  </div> 
							</div>
							<div style="margin-bottom:5px;" class="row">
								<div class="col-sm-12"> 
									<div class="form-group">
									    ...
									    <div class="col-sm-8">
									    	<div class="input-group">
									    		<input id="idkontak-<?php echo $i?>" value="<?php echo $nasabah->id_kontak?>"  name="idkontak[]" type="hidden" class="form-control" required/>
									       		<input id="kodekontak-<?php echo $i?>" value="<?php echo $nasabah->kode?>" readonly name="kodekontak[]" type="text" class="form-control" required/>
										       	<span class="input-group-btn">
									       			<button type="button" class="btn btn-primary" onclick="btnkontak(<?php echo $i?>)"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>&nbsp;Cari</button>
									       		</span>
								       		</div>
									    </div>
									</div>  
							...
							<div style="margin-bottom:5px;" class="row">
								<div class="col-sm-12">    
									  <div class="form-group">
										  ...
										  <div class="col-sm-8">          
											<input type="text" value="<?php echo $nasabah->nama?>" readonly  id="namaanggota-<?php echo $i?>" class="form-control" name="namaanggota[]" required/>
										  </div> 
									  </div>
								  </div>
							</div>
							<div style="margin-bottom:5px;" class="row">
								<div class="col-sm-12">    
									  <div class="form-group">
										  ...
										  <div class="col-sm-8">          
											<input type="text" value="<?php echo $nasabah->no_ktp?>" id="noktp-<?php echo $i?>" class="form-control" name="noktp[]" required/>
										  </div>
									  </div>
								  </div>
							</div>								
								...
								<div class="col-sm-12">    
									  <div class="form-group">
										  ...
										  <div style="margin-top:5px;" class="col-sm-8">          
											<select id="jeniskelamin-<?php echo $i?>" name="jeniskelamin[]" class="form-control">
												<option value="">--PILIH Jenis Kelamin--</option>
												<option <?php if($nasabah->jk == 'L'){ echo "selected=selected"; }?> value="L">Laki-laki</option>
												<option <?php if($nasabah->jk == 'P'){ echo "selected=selected"; }?> value="P">Perempuan</option>
											</select>
										  </div>
									  </div>
								  </div>
							...
							<div style="margin-bottom:5px;" class="row">
								<div class="col-sm-12">    
									  <div class="form-group">
										  ...
										  <div class="col-sm-8">          
											<input type="text" value="<?php echo $nasabah->alamat?>" readonly id="alamat-<?php echo $i?>" class="form-control" name="alamat[]"/>
										  </div>
									  </div>
								  </div>
							</div>
							<div style="margin-bottom:5px;" class="row">
								<div class="col-sm-12">    
									  <div class="form-group">
										  ...
										  <div class="col-sm-8">          
											<input type="text" value="<?php echo $nasabah->kodepos?>" readonly id="pos-<?php echo $i?>" class="form-control" name="pos[]"/>
										  </div>
									  </div>
								  </div>
							</div>
							<div style="margin-bottom:5px;" class="row">
								<div class="col-sm-12">    
									  <div class="form-group">
										  ...
										  <div class="col-sm-8">          
											<input type="text" value="<?php echo $nasabah->email?>" readonly id="email-<?php echo $i?>" class="form-control" name="email[]"/>
										  </div>
									  </div>
								  </div>
							</div>
							<div style="margin-bottom:5px;" class="row">
								<div class="col-sm-12">    
									  <div class="form-group">
										  ...
										  <div class="col-sm-8">          
											<textarea type="text" id="diskripsi-<?php echo $i?>" class="form-control" name="diskripsi[]"><?php echo $nasabah->deskripsi_nasabah?></textarea>
										  </div>
									  </div>
								  </div>
							</div>
...
<script type="text/javascript">
	...
	function hapusanggota(hps, del) {
		ojs = hps-1;
		isDelete = confirm('Yakin data akan dihapus ?');
		if(isDelete)
		{
			sendRequestForm('admin/hapussavereg', {IDDel: del}, 'content');
			$('#tmbinput-'+hps).remove();
			if (hps==0) {
				loadedituji();
	...
	function loadedituji()
	{
		var idx = "<?php echo $dataksm->id_ksm ?>";
...
function tambahBaruAnggota(){
	...
	var obj = $(".info-input").length;
		...
		tabn = -30;
				...
				var 
					mst = '<div class="content" id="tmbinput-'+obj+'"  style="margin-top:-60px; border-top:0px solid #3C8DBC; cursor:pointer; min-height:550px;">';
						mst += '<div type="button" style="background-color: #605ca8; color: white; margin: 60px '+tabn+'px; padding: 10px; text-align: center; font-size: 24px;">';
							mst += 'Form Anggota '+noform;
						mst += '</div>';
						mst += '<div class="row" style="margin-bottom:10px;">';
							mst += '<div class="col-md-12">';
	...
	function simpanreg()
	{
		var target = "<?php echo site_url("admin/updatesaveksm")?>";
