<?php if ( ! defined('BASEPATH') ) exit('No direct script access allowed');
    ...
    class Master_karyawan_model extends CI_Model{
        ...
        {
          $this->selectQuery = $this->db->query("select id_karyawan as IDKaryawan,                                                   
                                                  mstKaryawan.id_jabatan as IDJabatan,
                                                  mstKaryawan.id_group as IDGroup,
                                                  nama_jabatan as NamaJabatan, kode_karyawan as Kodekaryawan,
                                                  nama_karyawan As NamaKaryawan, alamat as Alamat, telp as Telp, email as Email, 
                                                  mstKaryawan.deskripsi as Deskripsi
                                                  from mst_karyawan mstKaryawan                                                  
                                                  left join ref_jabatan refJabatan
                                                  on mstKaryawan.id_jabatan = refJabatan.id_jabatan
          ...
          foreach ($this->selectQuery->result_array() as $row) {
            ...
            $arrSelectQuery[] = array('idx'         => $row['IDKaryawan'],
